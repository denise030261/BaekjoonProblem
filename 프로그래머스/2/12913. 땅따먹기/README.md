...
### 문제 풀이
<p>이 문제는 dp문제로 이전의 길과 동일하게 건너면 안되기 때문에 이전과 같은 길을 제외한 나머지의 길 중 최대값과 더해준다. 마지막까지 구한 뒤에 그 중에서 가장 큰 값이 점수의 최댓값이다</p>
