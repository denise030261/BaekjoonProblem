...
### 문제 풀이
 <p>직접 자르는 구간은 '(', ')'이 1차이임을 알아내 자르는 구간을 bounder에 저장한다. '('일 때 그의 순번을 스택에 저장하고 ')'일 때 스택에서 '('를 빼서 start 변수에 저장하고 ')'의 순번은 end변수에 저장하여 bounder를 통해서 조각을 쪼개주고 더해준다. </p>
![KakaoTalk_20240531_215452901](https://github.com/denise030261/BaekjoonProblem/assets/83278071/4dda01ae-f2b7-4331-95c6-32005bcc6655)
