...
### 문제 풀이
 ...
 <p>문제 번호와 점수를 입력 받아서 먼저 점수를 기준으로 정렬을 하여 가장 높은 점수 5개의 문제 번호를 다른 벡터에 저장하고 총 합을 구한다. 그런 뒤에 문제 번호가 저장된 벡터에 출력을 올림차순으로 해야하기 때문에 다시 올리차순으로 정렬을 하여 출력한다. </p>
