...
<p>에라토스테네스의 체의 방법을 이용해서 먼저 소수들을 구한다. 그 다음 짝수 n에 소수를 뺀 나머지가 소수인지 판단을 하면 되는데 이 때 두 소수의 차이가 가장 작은 것을 출력해야하기 때문에 짝수 n의 반부터 1까지 n에 빼주면서 둘 다 소수일 때 답을 도출한다.</p>
