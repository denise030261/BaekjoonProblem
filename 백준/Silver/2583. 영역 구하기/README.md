...
### 문제 풀이
 <p>이 문제는 영역의 문제로 그래프 풀이 방법을 이용해야 한다. 그래서 직사각형은 1로 처리하고 나머지는 0으로 처리하여 DFS로 영역을 구분해준다. 영역을 탐색할 때 방문했던 곳은 visited를 처리하며 영역의 넓이를 잰다.</p>

![KakaoTalk_20240627_195912249](https://github.com/denise030261/BaekjoonProblem/assets/83278071/c8564ad4-1da6-40cc-a8d1-fdf8c7bf0200)
