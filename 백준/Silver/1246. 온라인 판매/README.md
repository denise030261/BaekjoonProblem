...
### 문제 풀이
 <p>가장 낮은 가격으로 최대 수익을 올리는 문제로 먼저 달걀의 값을 입력 받은 뒤에 정렬을 한다. 정렬을 한 뒤에는 가장 낮은 달걀 가격부터 가장 높은 가격까지 그 가격에 살 수 있는 고객 수를 곱하여 최대 수익을 구한다. 고객 수를 구할 때는 그 만큼의 달걀의 수도 있는지도 확인해야한다</p>
