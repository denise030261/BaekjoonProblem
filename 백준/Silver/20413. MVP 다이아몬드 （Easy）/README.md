...
### 문제 풀이
 ...
 <p>이 문제는 등급이 정해져있기 때문에 그 이상으로 2개월의 과금을 할 수 없는 구조이다. 즉, 첫 달의 과금이 0이어도 두번째 달의 과금으로 등급을 맞출 수 있고 그 다음의 과금도 마찬가지이다. 즉, 두 달의 금액이 얼마이든 등급만 맞추면 되기 때문에 각 달의 과금은 등급의 금액에 이전달의 과금을 빼면 된다.</p>
