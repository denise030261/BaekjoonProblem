...
### 문제 풀이
 ...
 <p>최고의 피자를 고르기 위해서는 1원 당 열량이 가장 높아야한다. 주어진 조건을 보면 토핑의 가격은 똑같기 때문에 맨 처음에는 도우만 있는 피자부터 토핑의 열량을 내림차순으로 정렬한 뒤에 (도우 열량 + 토핑들의 열량)/(도우 가격 + 토핑들의 가격)으로 토핑들을 추가하면서 최고의 피자를 구한다.</p>
