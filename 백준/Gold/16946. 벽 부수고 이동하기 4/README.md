...
### 문제 풀이
 <p>이 문제는 dfs를 사용하여 문제를 풀었다. 벽 부분에서 dfs를 사용하여 문제를 풀었더니 시간초과가 났다. 그래서 다른 방면으로 생각을 하였는데 갈 수 있는 경로인 0의 구역을 먼저 구하는 것이다. 1에서로부터 이동할 수 있는 칸을 구하는 것이기 때문에 이 구역을 구하고자하는 것이다. 그래서 0의 구역을 dfs로 구하였고 1은 상하좌우에서의 구역을 더해서 출력을 하도록 하였다. </p>
