...
### 문제 풀이
 ...
 <p>처음 이전과 도착하기 이전에 1광년을 이동해야한다는 것을 감안하여 직접 계산을 해보면 (도착위치-출발위치)-2에서 나온 값에 루트를 씌울 때 소수값에 반올림을 하면 중간에 건너는 광년의 값이 나온다. 즉, 이 중간값과 2를 더해주면 답이 도출된다.</p>
