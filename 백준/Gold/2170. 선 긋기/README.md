...
### 문제 풀이
 <p>이 문제는 정렬을 할 [Gold V] 선 긋기 - 2170 
...
### 문제 풀이
 <p>이 문제는 오름차순으로 정렬을 한 뒤 끝마치는 점이 다음 시작하는 점과 끝마치는 점을 비교한다. 만약 다음 시작하는 점이 작거나 같고 끝마치는 점이 크면 그 끝마치는 점으로 바꾸고 만약에 시작하는 점이 크면 선이 끊겼다는 이야기니까 다시 선을 그린다. 이 방식으로 선의 총 길이를 구해준다.</p>
