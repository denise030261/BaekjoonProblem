...
### 문제 풀이 
 <p>이 문제는 dfs, bfs를 사용하였다. dfs가 아니라도 비트마스킹을 통해서 같은 팀과 다른 팀을 구분하여 bfs를 통해서 각 팀끼리 연결을 지을 수 있는지 확인할 수 있다. 이 두 알고리즘을 사용하여 인구 차이의 최솟값을 출력을 한다. </p>
