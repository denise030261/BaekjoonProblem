...
### 문제 풀이
 <p>이 문제는 투 포인터를 이용하여 문제를 풀었다. 처음에는 이분탐색과 투 포인터를 사용하여 문제를 풀었는데 그렇게 풀으니 탐색이 되지 않았다. 그래서 for문에서 첫 번째 수를 고정하고 나머지 수를 투 포인터를 사용하여 문제를 풀게 되었다.</p>
