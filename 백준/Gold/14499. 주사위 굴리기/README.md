...
### 문제 풀이
 <p>이 문제는 구현 문제로 문제에 나오대로 그대로 구하면 된다. 먼저 지도를 입력 받은 뒤에 명령어를 입력 받는다. 명령어대로 실행하면 되는데 문제는 주사위다. 동서남북에 따라서 주사위의 숫자가 바뀌는데 그것을 동서남북에 따라서 어떻게 나오는지 그려보고 그것을 직접 구현하였다. 그렇게 지도가 밖으로 나오지 않으면 주사위의 윗면을 출력하면서 명령어를 끝까지 도달하면 된다. <img width="1080" height="1440" alt="image" src="https://github.com/user-attachments/assets/b04042a9-2532-4974-ad5e-c0a4961fe92d" />
<img width="1080" height="1440" alt="image" src="https://github.com/user-attachments/assets/961dc361-e7d2-4b4d-9313-5c2fc7507e1e" />
 </p>
