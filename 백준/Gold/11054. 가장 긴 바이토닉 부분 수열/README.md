...
### 문제 풀이
 ...
 <p>가장 긴 바이토닉 부분 수열 구하는 것으로 LIS 알고리즘을 응용하여 구하였다. 먼저 점점 커지는 구간은 기존의 LIS를 구하는 방법으로 길이를 구한다. 반대로 작아지는 구간은 LIS 알고리즘에서 순서를 바꾸어서 길이를 구하여 두 길이를 합하여 가장 긴 바이토닉 부분 수열을 구하였다.</p>
