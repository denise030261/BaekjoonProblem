...
### 문제 풀이
 <p>이 문제는 그리디로 풀었다. 먼저 과제들을 과제 마감일을 기준으로 내림차순으로 정렬을 해준다. 그 후 마감이 제일 나중인 날부터 0일까지 과제들을 훑어 과제 마감일이 현재보다 같거나 클 때 가장 높은 점수인 과제를 수행하도록 한다.</p>
