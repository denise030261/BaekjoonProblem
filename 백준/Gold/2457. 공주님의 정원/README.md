...
### 문제 풀이
 <p>이 문제는 최대한 꽃들의 수를 적게 심으면 연속적으로 꽃을 한 가지 이상 피도록 해야하기 때문에 그리디를 이용하여 풀었다. 그래서 처음에는 꽃이 피는 기간이 3월1일 이전이면서 최대한 꽃을 지는 기간이 긴 것을 찾으면서 문제를 풀어나간다. 매일 꽃이 한 가지 이상이고 적게 꽃들을 심어야하기 때문이다. </p>
