...
<p>이 문제는 그래프 문제로 BFS를 이용하여 풀었다. 다른 그래프 문제와 다르게 이 문제는 x,y 뿐만 아니라 z축도 있기 때문에 2차원이 아닌 3차원으로 늘려주고 dx,dy,dz로 구성하고 각각 6개의 요소를 가지면서 문제를 풀면 된다.</p>
