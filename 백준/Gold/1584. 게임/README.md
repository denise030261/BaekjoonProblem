...
### 문제 풀이 
 <p>이 문제는 bfs로 풀었다. 근데 priority_queue를 사용하지 않고 deque를 사용하여 0의 구역을 만나면 앞에다 넣고 1의 구역을 만나면 뒤에다 넣어서 정렬을 하지 않고 잃는 생명의 최솟값을 구하도록 해야 시간 절약을 할 수 있다.</p>
