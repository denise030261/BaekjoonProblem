...
### 문제 풀이
 ...
 <p> 이 문제는 DP 문제로 가치를 1부터 k까지 bottom up 방식으로 진행한다. 해당 가치 값과 해당 가치 값에 각 종류의 가치를 뺀 값과 비교하면서 최솟값을 구해준다. 이로 인해 답변을 구하는데 최솟값을 구하지 못한 값은 -1을 출력한다.</p>
