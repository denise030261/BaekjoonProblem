...
### 문제 풀이
 <p>이 문제는 배낭 문제의 기본 문제로 풀어야 한다. 그래서 2차원 배열을 만들어서 1차원은 물품의 개수를 2차원은 가방의 무게로 두어서 dp로 문제를 풀어야 한다. 그래서 물품이 1번째면 1번째의 물품만 2번째면 1번째 물품의 배열에서 2번째 물품을 추가하여 가치를 측정하는 방식으로 문제를 풀었다. </p>
