...
### 문제 풀이
 ...
 <p>배낭 문제. 즉, Knapsack의 문제로 DP 알고리즘을 사용하여 문제를 푸려고 한다. 물건의 갯수 순서대로 무게를 점차적으로 높여 가치를 최대한 챙기는 방향으로 짰다. 그러면서 해당 물건 무게 이전에는 이전 물건들의 가치를 가져오고 해당 무게 이후에는 이전 물건들의 무게 가치의 값, 그 무게에 해당 무게를 뺀 가치와 해당 물건의 가치 더한 값과 비교하면서 큰 값을 가져온다.</p>

![KakaoTalk_20240628_193345535](https://github.com/denise030261/BaekjoonProblem/assets/83278071/075b7e36-a1ba-4eb1-a159-887b8a3d4c40)
