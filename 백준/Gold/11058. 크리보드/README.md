...
### 문제 풀이
 ...
 <p>dp문제로 출력하는 경우가 화면만 출력하거나 아니면 복사해서 내용을 붙이는 경우가 있다. 한 번만 복사할 수도 있고 아니면 여러번 복사할 수 있기 때문에 현재에서 3만큼 떨어지는 dp에서 2를 곱해주고 그 뒤로부터는 떨어지는 만큼 곱해지기 때문에 for문을 통해서 dp의 최댓값을 구한다.</p>
